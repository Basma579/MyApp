...
{
    public partial class EditCustomerID4 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Items", x => x.ItemD);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_order_Details_order_Header_Order_Header_ID",
            ...
            migrationBuilder.InsertData(
                table: "uOM",
                columns: new[] { "UomID", "Description", "Uom" },
                values: new object[] { 1, "Killogram", "KG" });
